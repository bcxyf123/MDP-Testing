...
from algs.pedm.ood_baselines.common.base_detector import Base_Detector
from algs.pedm.utils.callbacks import TrainCallback
from algs.pedm.utils.stats import one_step_batch_stats  # noqa

from algs.pedm.pedm.nn_models.default_cfg import model_cfg_dict
from algs.pedm.pedm.nn_models.prob_dyn_model import PEDM  # noqa
...
class PEDM_Detector(Base_Detector):
    ...
    def _fit(self, train_ep_data, val_ep_data, n_train_epochs=1_000, *args, **kwargs) -> None:
        """
        ...
        self.threshold = self.dyn_model.val_se_loss.max(0)
