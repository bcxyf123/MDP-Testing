...
from algo.value_eval import policy_eval
from envs.gym_simplegrid.env_generator import genEnv
...
def main(policy_id=0, map_id=0, read_path=None, save_path=None):
    ...
    env = genEnv(map_id=map_id, start_loc=(3,0), goal_loc=(0,7), deterministic=False, seed=222333)
    env.reset()
    v_table, delta_list = policy_eval(policy, env, iterations=1000)
